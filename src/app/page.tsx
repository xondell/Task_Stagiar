      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <header className="mb-20 text-center space-y-6">
          ...
          <p className="text-lg md:text-xl text-neutral-400 max-w-2xl mx-auto font-light leading-relaxed">
            Tehnoredactare complet automată a actelor juridice conform normelor oficiale de formatare. Alegeți tipul de act pentru a începe.
          </p>
        </header>
